...
public class AutoScreanForConsol extends Thread{
    ...
    public void run() {
        ...
        int currentScrean = 0;
            ...
            while (AutoScreanForConsol.isON) {


                bOutputStream = new ByteArrayOutputStream(1024);

                currentScrean++;
                System.out.print(ANSI_YELLOW+"\nСкрин "+currentScrean +" : "+ANSI_RESET);
            ...
            System.out.println("\nзагрузка завершена");
                ...
                try {
                    ...
                    System.exit(-1);
                }catch (AWTException eawte){ System.out.println("Не возможно сделать скриншот ошибки");System.exit(-1);}
